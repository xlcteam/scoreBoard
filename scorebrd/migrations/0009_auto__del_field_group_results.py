...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Group.results'
        raise RuntimeError("Cannot reverse this migration. 'Group.results' and its values cannot be restored.")
