...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamResult.group'
        db.add_column('scorebrd_teamresult', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['scorebrd.Group']),
                      keep_default=False)
