...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TeamResult.group'
        db.delete_column('scorebrd_teamresult', 'group_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TeamResult.start_time'
        raise RuntimeError("Cannot reverse this migration. 'TeamResult.start_time' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TeamResult.group'
        raise RuntimeError("Cannot reverse this migration. 'TeamResult.group' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TeamResult.end_time'
        raise RuntimeError("Cannot reverse this migration. 'TeamResult.end_time' and its values cannot be restored.")
    ...
    models = {
        ...
        'scorebrd.group': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'results': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['scorebrd.TeamResult']", 'symmetrical': 'False'}),
