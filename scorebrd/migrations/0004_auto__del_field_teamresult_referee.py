...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeamResult.referee'
        db.delete_column('scorebrd_teamresult', 'referee_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TeamResult.referee'
        raise RuntimeError("Cannot reverse this migration. 'TeamResult.referee' and its values cannot be restored.")
